...
MANAGERNAME = "SECURITYCONTROL"

class manager_SecurityControl:
    ...
    def __init__(self, programLogger, atm_Managers, IPCB_R, IPCB_T, IPCBStatusFlag_shmName, IPCBStatusFlag_AccessID_R, IPCBStatusFlag_AccessID_T):
        ...
        self.darHanlderDictionary = {"[SECURITY CONTROL] DAR TEST": "DAR TEST SUCCESSFUL", "ATMMANAGERS": self.atm_Managers, "PTIMERS": self.processTimers, "PTIMERS_AVGSTANDARD": self.processTimerAvgStandard}
    ...
    def __initializeFARs(self):
        def __FA_TESTFUNCTION(managerInstance, functionParams):
            try: return ("[SECURITY CONTROL] FAR TEST SUCCESSFUL with Function Params: " + str(functionParams))
